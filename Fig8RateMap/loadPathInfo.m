function [trialInfo, pathData, pathDataIdeal, pathDataLin] = loadPathInfo(sessInfo,extractMode)
%LOADINFO Load session information from each block directory
%
% [trialInfo, parsingInfo, pathData, pathDataIdeal, pathDataLin] = LOADINFO(sessInfo, i, extractMode)
%
