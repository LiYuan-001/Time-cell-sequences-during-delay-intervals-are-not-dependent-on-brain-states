...
function Fig8TreadmillArmChoice_PCAICA_DelayOnOff_Quant(inFile,AnalyzeSes)
close all
figureCount = 0;
ArmPCAChoice.rate = [];
...
figure
Violin(AssemblySimilarityOn,1,'ShowData',false);
hold on
Violin(AssemblySimilarityOff,2,'ShowData',false);
[H,P] = kstest2(AssemblySimilarityOn,AssemblySimilarityOff);
...
for n = 1:length(assemblyCat)
    ...
    bar(11,100*sum(SigArmChoice.on10.on.stemRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on10.on.shf_stemRateLRDiffAll95)),'FaceColor',[1,0,0.2]);
    hold on
    ...
    bar(11,100*sum(SigArmChoice.on10.off.stemRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on10.off.shf_stemRateLRDiffAll95)),'FaceColor',[1,0,0.2]);
    hold on
    ...
    figure
    bar(1,100*sum(SigArmChoice.on10.on.returnRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on10.on.shf_returnRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(2,100*sum(SigArmChoice.off10.on.returnRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off10.on.shf_returnRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(3,100*sum(SigArmChoice.on30.on.returnRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on30.on.shf_returnRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    bar(4,100*sum(SigArmChoice.off30.on.returnRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off30.on.shf_returnRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    
    bar(6,100*sum(SigArmChoice.on10.on.delayRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on10.on.shf_delayRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(7,100*sum(SigArmChoice.off10.on.delayRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off10.on.shf_delayRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(8,100*sum(SigArmChoice.on30.on.delayRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on30.on.shf_delayRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    bar(9,100*sum(SigArmChoice.off30.on.delayRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off30.on.shf_delayRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    
    bar(11,100*sum(SigArmChoice.on10.on.stemRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on10.on.shf_stemRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(12,100*sum(SigArmChoice.off10.on.stemRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off10.on.shf_stemRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(13,100*sum(SigArmChoice.on30.on.stemRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on30.on.shf_stemRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    bar(14,100*sum(SigArmChoice.off30.on.stemRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off30.on.shf_stemRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    
    bar(16,100*sum(SigArmChoice.on10.on.ChoRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on10.on.shf_ChoRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(17,100*sum(SigArmChoice.off10.on.ChoRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off10.on.shf_ChoRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(18,100*sum(SigArmChoice.on30.on.ChoRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.on30.on.shf_ChoRateLRDiffAll95(on_sim))),'FaceColor',[1,0,0.2]);
    bar(19,100*sum(SigArmChoice.off30.on.ChoRateLRDiffAll(on_sim))/sum(~isnan(ArmPCAChoice.off30.on.shf_ChoRateLRDiffAll95(on_sim))),'FaceColor',[0.6,0.6,0.6]);
    
    set(gca,'XTick',[1,2,3,4,6,7,8,9,11,12,13,14,16:19],'XTickLabel',{'on10','off10','on30','off30'});

    
    figure
    bar(1,100*sum(SigArmChoice.on10.off.returnRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on10.off.shf_returnRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(2,100*sum(SigArmChoice.off10.off.returnRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off10.off.shf_returnRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(3,100*sum(SigArmChoice.on30.off.returnRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on30.off.shf_returnRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    bar(4,100*sum(SigArmChoice.off30.off.returnRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off30.off.shf_returnRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
    
    bar(6,100*sum(SigArmChoice.on10.off.delayRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on10.off.shf_delayRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(7,100*sum(SigArmChoice.off10.off.delayRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off10.off.shf_delayRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(8,100*sum(SigArmChoice.on30.off.delayRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on30.off.shf_delayRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    bar(9,100*sum(SigArmChoice.off30.off.delayRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off30.off.shf_delayRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
    
    bar(11,100*sum(SigArmChoice.on10.off.stemRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on10.off.shf_stemRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(12,100*sum(SigArmChoice.off10.off.stemRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off10.off.shf_stemRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(13,100*sum(SigArmChoice.on30.off.stemRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on30.off.shf_stemRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    bar(14,100*sum(SigArmChoice.off30.off.stemRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off30.off.shf_stemRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
    
    bar(16,100*sum(SigArmChoice.on10.off.ChoRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on10.off.shf_ChoRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    hold on
    bar(17,100*sum(SigArmChoice.off10.off.ChoRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off10.off.shf_ChoRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
    bar(18,100*sum(SigArmChoice.on30.off.ChoRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.on30.off.shf_ChoRateLRDiffAll95(off_sim))),'FaceColor',[1,0,0.2]);
    bar(19,100*sum(SigArmChoice.off30.off.ChoRateLRDiffAll(off_sim))/sum(~isnan(ArmPCAChoice.off30.off.shf_ChoRateLRDiffAll95(off_sim))),'FaceColor',[0.6,0.6,0.6]);
